...
public class ClienteResource {
	...
	public Response deletarCliente(Cliente cliente) {
		...
		if (isClienteDeletado == true) {
			...
			System.out.println("Erro no servidor  ao deletar cliente: " + cliente.getNome());
			return Response.status(500).entity("Erro no servidor  ao deletar cliente: " + cliente.getNome()).build();
		}
